...
// bubble_sort:
//      function implementing the basic version of bubble sort. 
//      The following implementation doesn't have improvements to optimize the bubblesort algorithm.

fn bubble_sort(vec: &mut Vec<i32>, num_items: i32) {
